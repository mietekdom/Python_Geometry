...
########Square#########
        ...
        self.square_result1.place(x=290, y=150)
...
########Functions#########
    ...
    def square(self):
        self.square_equation = float(self.side_of_square.get()) ** 2
    ...
    def triangle(self):
        self.triangle_equation = (float(self.height_of_triangle.get()) * float(self.base_of_triangle.get())) * 0.5
    ...
    def circle(self):
        self.circle_equation = (float(self.radius.get()) ** 2 * 3.14)
